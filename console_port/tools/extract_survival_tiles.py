...
A few tile classes are not part of the supplied source subset. Their Material
comes from MISSING_CLASS_MATERIAL below and is marked `reconstructed` in the
generated table so it can be replaced once those files are imported.
"""
...
# Classes whose .cpp is absent from the supplied subset.
MISSING_CLASS_MATERIAL = {
    'StoneTile': 'stone', 'OreTile': 'stone', 'DirtTile': 'dirt', 'GravelTile': 'sand',
    'Sponge': 'sponge', 'DispenserTile': 'stone', 'ClayTile': 'clay', 'SnowTile': 'snow',
    'WebTile': 'web', 'TntTile': 'explosive', 'BookshelfTile': 'wood', 'ObsidianTile': 'stone',
    'MobSpawnerTile': 'stone', 'WorkbenchTile': 'wood', 'SignTile': 'wood',
    'RedStoneOreTile': 'stone', 'IceTile': 'ice', 'RecordPlayerTile': 'wood',
    'HellStoneTile': 'stone', 'CakeTile': 'cake', 'LockedChestTile': 'wood', 'MetalTile': 'metal',
    'MusicTile': 'wood', 'DetectorRailTile': 'decoration', 'EggTile': 'egg',
    'TheEndPortalFrameTile': 'glass', 'MycelTile': 'grass', 'WoodSlabTile': 'wood',
    'SoulSandTile': 'sand', 'LightGemTile': 'glass', 'PistonMovingPiece': 'piston',
}
...
def class_info(cls):
    ...
    elif cls in MISSING_CLASS_MATERIAL:
        result = (MISSING_CLASS_MATERIAL[cls], None, True)
