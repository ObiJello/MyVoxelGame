...
explosions, and explodes with the original `Explosion`. Dispensers throw items, empty
and fill buckets and hatch spawn eggs when powered. Pigs, cows, sheep and chickens run on
the source's mob AI: they wander, panic, follow food, breed, grow up, eat grass and
lay eggs; sheep can be sheared and cows milked. Other unfinished systems include per-chunk mesh uploads,
