...
::world::IBlockType* OreVeinifier::getOre(VeinType type) {
    switch (type) {
        case VeinType::COPPER: return ::world::MinecraftBlocks::COPPER_ORE();
        case VeinType::IRON: return ::world::MinecraftBlocks::DEEPSLATE_IRON_ORE();
        default: return nullptr;
    }
}

::world::IBlockType* OreVeinifier::getRawOreBlock(VeinType type) {
    switch (type) {
        case VeinType::COPPER: return ::world::MinecraftBlocks::RAW_COPPER_BLOCK();
        case VeinType::IRON: return ::world::MinecraftBlocks::RAW_IRON_BLOCK();
        default: return nullptr;
    }
}

::world::IBlockType* OreVeinifier::getFiller(VeinType type) {
    switch (type) {
        case VeinType::COPPER: return ::world::MinecraftBlocks::GRANITE();
        case VeinType::IRON: return ::world::MinecraftBlocks::TUFF();
        default: return nullptr;
    }
}
...
::world::IBlockType* OreVeinifier::calculate(
