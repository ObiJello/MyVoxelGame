...
world::IBlockType* FluidStatus::at(int32_t blockY) const {
    ...
    return (blockY < fluidLevel) ? fluidType : ::world::MinecraftBlocks::AIR();
}

// SeaLevelFluidPicker implementation
SeaLevelFluidPicker::SeaLevelFluidPicker(int32_t seaLevel, world::IBlockType* waterBlock)
    : m_seaLevel(seaLevel)
