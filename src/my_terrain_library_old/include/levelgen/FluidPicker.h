...
struct FluidStatus {
    ...
    ::world::IBlockType* fluidType;  // Type of fluid (water, lava, or air)
     ...
     */
    ::world::IBlockType* at(int32_t blockY) const;
...
private:
    int32_t m_seaLevel;
    ::world::IBlockType* m_waterBlock;

public:
    SeaLevelFluidPicker(int32_t seaLevel, ::world::IBlockType* waterBlock);
...
private:
    ...
    ::world::IBlockType* m_waterBlock;
    ::world::IBlockType* m_lavaBlock;

public:
    OverworldFluidPicker(
        int32_t seaLevel,
        int32_t lavaLevel,
        ::world::IBlockType* waterBlock,
        ::world::IBlockType* lavaBlock
    );
