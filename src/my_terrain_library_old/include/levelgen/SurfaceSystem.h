...
private:
    ...
    std::vector<::world::IBlockType*> m_clayBands;
    ...
    static std::vector<::world::IBlockType*> generateBands(XoroshiroRandomSource& random);
...
public:
     ...
     */
    ::world::IBlockType* getBand(int32_t worldX, int32_t y, int32_t worldZ) const;
...
private:
     ...
     */
    bool isStone(const ::world::IBlockType* block) const;
