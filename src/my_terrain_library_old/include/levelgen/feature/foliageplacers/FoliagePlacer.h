...
public:
     ...
     */
    virtual int foliageHeight(XoroshiroRandomSource& random, int treeHeight) const = 0;

    /**
     * Get foliage radius
     * Reference: FoliagePlacer.java lines 42-44
     */
    virtual int foliageRadius(XoroshiroRandomSource& random, int trunkHeight) const {
...
public:
    ...
    int foliageHeight(XoroshiroRandomSource& random, int treeHeight) const override {
        return m_height;
    }
...
public:
    ...
    int foliageRadius(XoroshiroRandomSource& random, int trunkHeight) const override;
