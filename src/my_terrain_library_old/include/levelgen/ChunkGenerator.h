...
private:
    ...
    ::world::IBlockType* m_defaultBlock;  // Stone
    ::world::IBlockType* m_airBlock;      // Air
...
public:
    ...
    void setDefaultBlock(::world::IBlockType* block) { m_defaultBlock = block; }
    void setAirBlock(::world::IBlockType* block) { m_airBlock = block; }
