...
public:
     ...
     */
    ::world::IBlockType* calculate(const density::DensityFunction::FunctionContext& context) const override;
    ...
    static ::world::IBlockType* getOre(VeinType type);
    static ::world::IBlockType* getRawOreBlock(VeinType type);
    static ::world::IBlockType* getFiller(VeinType type);
