...
public:
     ...
     */
    virtual IBlockType* getBlockState(const BlockPos& pos) = 0;

    /**
     * Get block at relative position (x, z in 0-15, y in getMinBuildHeight() to getMaxBuildHeight())
     */
    virtual IBlockType* getBlockState(int localX, int y, int localZ) = 0;
     ...
     */
    virtual IBlockType* setBlockState(const BlockPos& pos, IBlockType* state, bool moved) = 0;

    /**
     * Set block at relative position
     */
    virtual IBlockType* setBlockState(int localX, int y, int localZ, IBlockType* state, bool moved) = 0;
