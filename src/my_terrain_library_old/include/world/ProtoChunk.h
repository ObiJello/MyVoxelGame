...
private:
    ...
    util::BlockStateStrategy<IBlockType*> m_blockStrategy;
    IBlockType* m_airBlock;
    IBlockType* m_defaultBlock;
...
public:
        ...
        , m_inhabitedTime(0)
    {
        ...
        auto blockGetter = [this](int32_t x, int32_t y, int32_t z) -> const IBlockType* {
     ...
     */
    LevelChunkSection& getSection(int32_t index) {
     ...
     */
    IBlockType* getBlockState(const core::BlockPos& pos) override {
     ...
     */
    IBlockType* setBlockState(const core::BlockPos& pos, IBlockType* state, bool moved) override {
    ...
    IBlockType* setBlockState(int localX, int y, int localZ, IBlockType* state, bool moved) override {
        ...
        int32_t localY = y & 15;
        IBlockType* oldState = section.setBlockState(localX, localY, localZ, state, !moved);
     ...
     */
    int32_t getHighestSectionPosition() const {
     ...
     */
    IBlockType* getDefaultBlock() const {
