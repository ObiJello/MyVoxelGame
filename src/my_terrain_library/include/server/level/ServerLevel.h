...
public:
     ...
     */
    BlockState* getAirBlock() const { return m_airBlock; }

    /**
     * Get the default block type (used for unknown blocks)
     */
    BlockState* getDefaultBlock() const { return m_defaultBlock; }
    ...
    /**
     * Alias for getMinBuildHeight (used by WorldGenRegion)
     */
