...
public:
     ...
     */
    virtual bool test(BlockState* state, WorldgenRandom& random) const = 0;
};
...
public:
    ...
    bool test(BlockState* state, WorldgenRandom& random) const override {
        ...
        // Reference: data/minecraft/tags/blocks/stone_ore_replaceables.json
        // IMPORTANT: Does NOT include tuff - only stone and decorative stones
