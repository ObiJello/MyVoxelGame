...
IntegerProperty* BlockStateProperties::DRIED_GHAST_HYDRATION = nullptr;
...
EnumProperty<NoteBlockInstrument>* BlockStateProperties::NOTEBLOCK_INSTRUMENT = nullptr;
EnumProperty<TrialSpawnerState>* BlockStateProperties::TRIAL_SPAWNER_STATE = nullptr;
EnumProperty<VaultState>* BlockStateProperties::VAULT_STATE = nullptr;
...
void BlockStateProperties::initialize() {
    ...
    DRIED_GHAST_HYDRATION = own(IntegerProperty::create("hydration", 0, 3));
    ...
    NOTEBLOCK_INSTRUMENT = own(EnumProperty<NoteBlockInstrument>::create("instrument", NoteBlockInstrument::values()));
    TRIAL_SPAWNER_STATE = own(EnumProperty<TrialSpawnerState>::create("trial_spawner_state", TrialSpawnerState::values()));
    VAULT_STATE = own(EnumProperty<VaultState>::create("vault_state", VaultState::values()));
