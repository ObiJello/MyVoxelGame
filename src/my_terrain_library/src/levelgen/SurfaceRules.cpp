...
//
// BiomeCondition must use LazyYCondition to match Java behavior.
// The BiomeManager fiddling algorithm uses Y coordinate, so biome can
// vary by Y level at biome boundaries. Using LazyXZCondition caused
// parity issues with ice/snow placement in frozen_peaks/grove biomes.
