// File: src/common/world/gen/ProceduralChunkGenerator.hpp
#pragma once
...
namespace Game {
    ...
    struct BiomeConfig {
        ...
        // Surface blocks
        BlockID surfaceBlock = BlockID::Grass;  // Legacy field for compatibility
        BlockID fillerBlock = BlockID::Dirt;
        BlockID stoneBlock = BlockID::Stone;
        
        // Underwater terrain materials
        BlockID topMaterial = BlockID::Grass;      // Material used above sea level
        BlockID underMaterial = BlockID::Sand;     // Shallow underwater material (filler)
        BlockID underwaterMaterial = BlockID::Gravel;  // Deep underwater material
        int seaLevel = 62;  // Water level for this biome
    ...
    private:
        ...
        BlockID GetSurfaceBlockForDepth(int surfaceHeight, const BiomeConfig& biomeConfig, std::mt19937& rng) const;
