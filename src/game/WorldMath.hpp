...
namespace Game::Math {
    ...
    // A chunk is 16×16×256; each chunk is subdivided into 16 sections of height 16.
    ...
    constexpr int SECTIONS_PER_CHUNK   = 16;               // 256 / 16
    constexpr int CHUNK_TOTAL_HEIGHT   = SECTION_HEIGHT * SECTIONS_PER_CHUNK; // 256
