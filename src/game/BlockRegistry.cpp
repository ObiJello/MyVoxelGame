...
namespace Game {
    ...
    static void RegisterBlock(BlockID id, const std::string& name, bool opaque, std::array<uint8_t,6> texIndices) {
    ...
    void BlockRegistry::Init() {
        ...
        // 1: Stone (opaque; same texture on all faces)
        ...
        RegisterBlock(BlockID::Grass, "Grass", true,  {4,4,3,2,4,4});
